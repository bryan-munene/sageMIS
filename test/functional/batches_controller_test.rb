...
class BatchesControllerTest < ActionController::TestCase
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post :create, batch: { date: @batch.date, description: @batch.description, name: @batch.name, no_of_items: @batch.no_of_items }
    end
  ...
  test "should update batch" do
    put :update, id: @batch, batch: { date: @batch.date, description: @batch.description, name: @batch.name, no_of_items: @batch.no_of_items }
    assert_redirected_to batch_path(assigns(:batch))
  end

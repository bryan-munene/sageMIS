...
class SaleItemsControllerTest < ActionController::TestCase
  ...
  test "should create sale_item" do
    assert_difference('SaleItem.count') do
      post :create, sale_item: { batch_id: @sale_item.batch_id, item_id: @sale_item.item_id, sale_id: @sale_item.sale_id }
    end
  ...
  test "should update sale_item" do
    put :update, id: @sale_item, sale_item: { batch_id: @sale_item.batch_id, item_id: @sale_item.item_id, sale_id: @sale_item.sale_id }
    assert_redirected_to sale_item_path(assigns(:sale_item))
  end

...
ActiveRecord::Schema.define(:version => 20140729154830) do
  ...
  create_table "sale_items", :force => true do |t|
    t.integer  "item_id"
    t.integer  "sale_id",    :limit => 8
    t.integer  "batch_id"
    t.datetime "created_at",                                             :null => false
    t.datetime "updated_at",                                             :null => false
    t.decimal  "quantity",                :precision => 15, :scale => 2
    t.decimal  "linecost",                :precision => 15, :scale => 2
  end
  ...
  create_table "sales", :force => true do |t|
    ...
    t.datetime "created_at",                                     :null => false
    t.datetime "updated_at",                                     :null => false
    t.decimal  "valueofsale",     :precision => 15, :scale => 2
    t.decimal  "discountamount",  :precision => 15, :scale => 2
  end
